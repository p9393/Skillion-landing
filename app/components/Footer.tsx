            ...
            <div className="mx-auto max-w-6xl px-6 py-16">
                ...
                <div className="mx-auto mt-16 grid max-w-5xl gap-8 md:grid-cols-4 px-6 md:px-12">
                    ...
                    <div>
                        ...
                        <h4 className="text-sm font-semibold text-white mb-4 mt-8">Community</h4>
                        <ul className="flex items-center gap-4">
                            <li>
                                <a
                                    ...
                                    title="Join Discord"
                                    className="flex items-center justify-center h-9 w-9 rounded-xl border border-white/10 bg-white/[0.03] text-white/50 hover:border-[#5865F2]/40 hover:bg-[#5865F2]/10 hover:text-[#5865F2] transition-all"
                                >
                            ...
                            <li>
                                <a
                                    ...
                                    rel="noopener noreferrer"
                                    title="Join Telegram"
                                    className="flex items-center justify-center h-9 w-9 rounded-xl border border-white/10 bg-white/[0.03] text-white/50 hover:border-[#29A8E0]/40 hover:bg-[#29A8E0]/10 hover:text-[#29A8E0] transition-all"
                                >
                                    <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <li>
                                <a
                                    ...
                                    className="flex items-center justify-center h-9 w-9 rounded-xl border border-white/10 bg-white/[0.03] text-white/50 hover:border-[#E1306C]/40 hover:bg-[#E1306C]/10 hover:text-[#E1306C] transition-all"
                                >
