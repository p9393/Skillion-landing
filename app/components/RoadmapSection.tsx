        ...
        milestones: [
            {
                ...
                description: "Core SDI framework operational. Risk-adjusted scoring methodology implemented and tested. API live with snapshot history and factor breakdown.",
                status: "Completed",
            ...
            },
            {
                ...
                description: "Personal reputation dashboard operational with score breakdown, trade timeline, insights, account connections, and settings.",
                status: "Completed",
                statusColor: "text-emerald-400 border-emerald-400/30 bg-emerald-400/10",
            },
            {
                ...
                description: "MT4/MT5 statement upload live. Broker data ingestion pipeline active. DeFi wallet and CeFi platform connectors in development.",
                status: "In Progress",
            ...
            },
            {
                ...
                description: "Reputation tier standards defined: Observer, Trader, Senior, Elite. Automated certification logic under implementation.",
                status: "In Progress",
                statusColor: "text-sky-400 border-sky-400/30 bg-sky-400/10",
            },
            {
                ...
                description: "Waitlist active. Founding cohort onboarding in progress. Initial behavioral data collection and framework validation underway.",
                status: "In Progress",
                statusColor: "text-sky-400 border-sky-400/30 bg-sky-400/10",
            },
        ],
